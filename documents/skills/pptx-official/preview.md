...
file is written. This phase sits between Phase 2 (outline) and Phase 4 (build).

## When to preview

| Condition | Action |
|-----------|--------|
| User asks to see options, says "preview", "show me", "xem truoc" | Preview |
...
<div class="grid">
  <!-- One card per recommended theme. Adapt CSS variables per card for dark/light themes. -->
...
- **Confirm** ("OK", "looks good", "duyệt") -- proceed to Phase 4 (build)
- **Request changes** ("slide 3 needs a table not a chart") -- adjust outline,
  rebuild preview, show again
- **Skip** ("just build it") -- proceed to Phase 4 directly
