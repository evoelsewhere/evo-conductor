...
pub struct DashboardSummary {
    ...
    /// Backward-compatible alias for `presence.members_seen_recently`.
    pub members_online: u32,
    pub secrets_active: u32,
    pub resources: ResourceCounts,
    pub sso_enabled: bool,
    pub presence: DashboardPresence,
    pub realtime: DashboardRealtime,
    pub host_metrics: DashboardHostMetrics,
    pub feedback: DashboardFeedbackSummary,
}
