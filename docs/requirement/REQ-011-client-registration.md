...
| AC-5 | The registration response includes the active telemetry and privacy configuration, including the collection level from [REQ-015](REQ-015-privacy-controls.md) |
| AC-6 | EvoFlux displays the connected project name and logo, satisfying V1 acceptance criterion 4 |
| AC-7 | The token is stored in the operating system credential store, per [REQ-006](REQ-006-connection-tokens.md) AC-9 |
...
- Resource download, covered by [REQ-012](REQ-012-resource-sync-client.md).
- Inventory contents, covered by [REQ-013](REQ-013-inventory-synchronization.md).
- Telemetry upload, covered by [REQ-014](REQ-014-telemetry-ingestion.md).
...
| 3 | Token accidentally logged during connection troubleshooting | High | [REQ-006](REQ-006-connection-tokens.md) AC-9 |
