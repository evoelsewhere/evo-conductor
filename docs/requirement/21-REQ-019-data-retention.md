...
| AC-6 | The active retention policy is visible to every member, per [REQ-015](11-REQ-015-privacy-controls.md) AC-1 |
| AC-7 | Changing the policy is recorded in the audit log ([REQ-018](05-REQ-018-audit-logging.md)) |
| AC-8 | Shortening a retention period does not delete data retroactively without an explicit confirmation |
| AC-9 | Records belonging to a disabled member are retained according to policy rather than deleted on disablement, per [REQ-005](07-REQ-005-member-lifecycle.md) AC-5 |
