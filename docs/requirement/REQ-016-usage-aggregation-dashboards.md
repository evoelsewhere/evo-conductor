...
| Blocks | REQ-017, V1 acceptance criterion 8 |
...
| AC-7 | A User sees only personal usage; project-wide endpoints return `403` per [REQ-004](REQ-004-api-authorization.md) |
...
- Cost, covered by [REQ-017](REQ-017-cost-estimation.md).
- Individual productivity scoring or ranking of members. This is deliberately excluded; see
  [REQ-015](REQ-015-privacy-controls.md) risk 1.
...
| 4 | The dashboard is read as a performance ranking of individuals | High | Section 5 excludes it explicitly, and [REQ-015](REQ-015-privacy-controls.md) AC-7 makes the data symmetric |
...
- May a Contributor see per-member figures, or only project totals? This mirrors the open question in
  [REQ-004](REQ-004-api-authorization.md) and must be answered once for both.
