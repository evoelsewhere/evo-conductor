...
export const GOVERNED_DASHBOARD_ANALYTICS = {
  ...
  totals: {
    ...
    cache_savings_usd_micros: 940_000,
  ...
  previous_period: {
    requests: 1_050,
    tokens_in: 4_200_000,
    tokens_out: 1_050_000,
    cache_read_tokens: 420_000,
    cache_write_tokens: 60_000,
    total_tokens: 5_250_000,
    estimated_cost_usd_micros: 13_800_000,
    cache_savings_usd_micros: 640_000,
  },
  daily: [
